...
public class ActorDaoTest {
    ...
    public void createTest() {
        ...
        newActor = actorDao.createActor(newActor);
    ...
    public void readListTest() {
        ...
        assertArrayEquals(expected, actorDao.getAllActors().toArray());
    }

    @Test
    @DatabaseSetup("/initData.xml")
    public void readByIdTest() {
        Actor actualActor = actorDao.getActorById(1);
    ...
    public void deleteTest() {
        actorDao.deleteActor(new Actor(2, null, null));
        //this is when the whole suite is run together and create is called
        actorDao.deleteActor(new Actor(3, null, null));
    }
}
